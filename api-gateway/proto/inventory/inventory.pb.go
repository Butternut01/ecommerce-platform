...
const file_inventory_proto_rawDesc = "" +
	...
	"\bquantity\x18\x05 \x01(\x05R\bquantity\"\x8e\x01\n" +
	"\x14UpdateProductRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12 \n" +
	"\vdescription\x18\x03 \x01(\tR\vdescription\x12\x14\n" +
	"\x05price\x18\x04 \x01(\x02R\x05price\x12\x1a\n" +
	"\bquantity\x18\x05 \x01(\x05R\bquantity\"1\n" +
	...
	"\bproducts\x18\x01 \x03(\v2\x12.inventory.ProductR\bproducts\"\x81\x01\n" +
	"\aProduct\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12 \n" +
	"\vdescription\x18\x03 \x01(\tR\vdescription\x12\x14\n" +
	"\x05price\x18\x04 \x01(\x02R\x05price\x12\x1a\n" +
	"\bquantity\x18\x05 \x01(\x05R\bquantity2\xa1\x03\n" +
	...
	"\fListProducts\x12\x1e.inventory.ListProductsRequest\x1a\x1f.inventory.ListProductsResponseBGZEgithub.com/Butternut01/ecommerce-platform/api-gateway/proto/inventoryb\x06proto3"
...
var file_inventory_proto_goTypes = []any{
	...
	(*ListProductsRequest)(nil),   // 8: inventory.ListProductsRequest
	(*ListProductsResponse)(nil),  // 9: inventory.ListProductsResponse
	(*Product)(nil),               // 10: inventory.Product
}
var file_inventory_proto_depIdxs = []int32{
	10, // 0: inventory.ListProductsResponse.products:type_name -> inventory.Product
	0,  // 1: inventory.InventoryService.AddProduct:input_type -> inventory.AddProductRequest
	2,  // 2: inventory.InventoryService.GetProduct:input_type -> inventory.GetProductRequest
	4,  // 3: inventory.InventoryService.UpdateProduct:input_type -> inventory.UpdateProductRequest
	6,  // 4: inventory.InventoryService.DeleteProduct:input_type -> inventory.DeleteProductRequest
	8,  // 5: inventory.InventoryService.ListProducts:input_type -> inventory.ListProductsRequest
	1,  // 6: inventory.InventoryService.AddProduct:output_type -> inventory.AddProductResponse
	3,  // 7: inventory.InventoryService.GetProduct:output_type -> inventory.GetProductResponse
	5,  // 8: inventory.InventoryService.UpdateProduct:output_type -> inventory.UpdateProductResponse
	7,  // 9: inventory.InventoryService.DeleteProduct:output_type -> inventory.DeleteProductResponse
	9,  // 10: inventory.InventoryService.ListProducts:output_type -> inventory.ListProductsResponse
