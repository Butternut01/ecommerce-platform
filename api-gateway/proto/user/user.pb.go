...
const file_user_proto_rawDesc = "" +
	...
	"\fAuthenticate\x12\x19.user.AuthenticateRequest\x1a\x1a.user.AuthenticateResponseBBZ@github.com/Butternut01/ecommerce-platform/api-gateway/proto/userb\x06proto3"
...
var file_user_proto_depIdxs = []int32{
	...
	2, // 1: user.UserService.Authenticate:input_type -> user.AuthenticateRequest
	1, // 2: user.UserService.Register:output_type -> user.RegisterResponse
	3, // 3: user.UserService.Authenticate:output_type -> user.AuthenticateResponse
